...
replace isExpectedToHaveDelivered=1 if expected_due_delivery<mdy(9,1,2017)
...
save "data_clean/with_indicators.dta", replace




// keep if row number == 0
// (this is no one, it makes an empty dataset)
keep if _n==0

save "data_clean/merged_and_empty_dataset.dta", replace
