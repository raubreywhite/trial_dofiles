...
#gravida, para, abo can get from prev pregnancies, no need to keep control variables for them
  ...
  varsKeep <- c(
   ...
   #"ident_hr_clinic",
    ...
    names(d)[stringr::str_detect(names(d),"^angestagedays_[0-9]*")],
    ...
    names(d)[stringr::str_detect(names(d),"^labgestagedays_[0-9]*")],
    ...
    names(d)[stringr::str_detect(names(d),"^usgestagedays_[0-9]*")],
    ...
    names(d)[stringr::str_detect(names(d),"^riskgestagedays_[0-9]*")],
    ...
    names(d)[stringr::str_detect(names(d),"^mangestagedays_[0-9]*")],
