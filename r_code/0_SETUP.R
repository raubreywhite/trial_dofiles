Setup <- function(IS_GAZA=FALSE){
  ...
  REF_GAZA_CLINIC_INTERVENTION_DATE <- "2019-01-08"
  REF_GAZA_CLINIC_CONTROL_DATE<- "2019-01-08"
  ...
  WB_CLINIC_INTERVENTION_DATE <- "2019-03-04"
  WB_CLINIC_CONTROL_DATE <- "2019-03-04"
